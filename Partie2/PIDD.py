...
plt.tight_layout()
plt.savefig('Partie2/PIDD_results/comparaison_performances.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Partie2/PIDD_results/courbes_roc.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Partie2/PIDD_results/matrices_confusion.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('Partie2/PIDD_results/precision_rappel_par_classe.png', dpi=300, bbox_inches='tight')
...
df_performance.to_csv('Partie2/PIDD_results/tableau_performances.csv', index=False, encoding='utf-8-sig')
...
print("\n✅ Toutes les visualisations ont été sauvegardées dans le dossier 'Partie2/PIDD_results/'")
